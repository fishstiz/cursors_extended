...
public class CursorTypesExt {
    ...
    public static final CursorType BUSY = createStandardCursor(SDLMouse.SDL_SYSTEM_CURSOR_WAIT, "busy", CursorType.DEFAULT);
    public static final CursorType RESIZE_NWSE = createStandardCursor(SDLMouse.SDL_SYSTEM_CURSOR_NWSE_RESIZE, "resize_nwse", CursorType.DEFAULT);
    public static final CursorType RESIZE_NESW = createStandardCursor(SDLMouse.SDL_SYSTEM_CURSOR_NESW_RESIZE, "resize_nesw", CursorType.DEFAULT);
